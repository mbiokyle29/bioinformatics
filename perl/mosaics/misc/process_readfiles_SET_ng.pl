...
given($format)
{
    when("eland_result" )    { $sub_ref = \&eland_result; }
    when ("eland_extended" ) { $sub_ref = \&eland_result; }
    when ("eland_export" )   { $sub_ref = \&eland_result; }
    when ("bowtie" )         { $sub_ref = \&eland_result; }
    when ("sam" )            { $sub_ref = \&eland_result; }
    when ("bed" )            { $sub_ref = \&eland_result; }
    when ("csem" )           { $sub_ref = \&eland_result; }
    default {
